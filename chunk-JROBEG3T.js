import {
  ...
  y as nr,
  z as ze,
} from "./chunk-NUY2RPSF.js";
import { a as Ze, b as _r } from "./chunk-QV7AMSUB.js";
import { a as d, b as v, d as Je, l as g } from "./chunk-QE6IBIJD.js";
    ...
    i = (s, a) => {
      for (let m of s) {
        ...
        if (p === "address" && typeof l == "string" && !tr(l))
          throw new er({ address: l });
        let f = p.match(or);
        if (f) {
          let [E, y] = f;
          if (y && U(l) !== Number.parseInt(y))
            throw new Qe({ expectedSize: Number.parseInt(y), givenSize: U(l) });
        }
        let c = n[p];
        c && (Or(p), i(c, l));
      }
...
function wr(t) {
  return g(this, arguments, function* ({ hash: e, signature: r }) {
    let o = K(e) ? e : F(e),
      { secp256k1: n } = yield import("./chunk-ZVGVTZ5S.js");
    return `0x${(() => {
      ...
      return g(this, null, function* () {
        ...
        try {
          let u = yield We(
            ...
            {
              errorInstance: new ke({ body: n, url: e }),
              timeout: a,
              signal: !0,
            }
          );
          ...
          throw u instanceof M || u instanceof ke
            ? u
